...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{pics/theoretical.pdf}
\captionstyle{normal}\caption{Теоретическая оценка приближенных методов перестроения выпуклой поверхности в двумерном случае.}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{pics/accuracy_okrestnost.pdf}
\captionstyle{normal}\caption{Вычисление смещения узла в методе окрестностей для выпуклой сетки.}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{pics/theoretical_concave.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{pics/accuracy_okrestnost2.pdf}
\captionstyle{normal}\caption{Вычисление смещения узла в методе окрестностей для вогнутой сетки.}
\label{fig:text_1_remesh_2d_accuracy_okrestnost}
\end{figure}
...
\captionstyle{normal}\caption{Графики поверхностнй $\delta_i^r(\alpha, \frac{\Delta H}{l})$, $\delta_i^t(\alpha, \frac{\Delta H}{l})$, $\delta_i^o(\alpha, \frac{\Delta H}{l})$ при фиксированном значении $H = \frac{l}{2}$.}
