...
Checking the coincidence of the corner nodes of two potentially linked boundary conditions is determined by considering four possible cases, taking into account the renaming of vertices: the quadrangle $A_0B_0C_0D_0$ can coincide with one of the quadrangles $ABCD$, $DABC$, $CDAB$, $BCDA$ (Fig.~\ref{fig:match}).
...
In addition to the fact that the angular nodes of a pair of border conditions coincide, a correspondence between their coordinate systems is also established.
...
% Bibs for CFD and RANS/ILES sections.
