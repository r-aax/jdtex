...
% Рис.1
\begin{figure}[h]
\includegraphics[width=1.0\textwidth]{pics/pic. 1_2.png}
...
\begin{figure}[h]
\includegraphics[width=0.6\textwidth]{pics/pic. 2.png}
...
\begin{figure}[h]
\includegraphics[width=1.0\textwidth]{pics/pic. 3.png}
...
\begin{figure}[h]
\includegraphics[width=1.0\textwidth]{pics/pic. 4.pdf}
...
\begin{figure}[h]
\includegraphics[width=0.3\textwidth]{pics/pic. 5.png}
...
\begin{figure}[h]
\includegraphics[width=0.8\textwidth]{pics/pic. 6.pdf}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{pics/pic. 7.png}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{pics/pic. 8.png}
\captionstyle{center}\caption{Перестроение треугольника по точке на ребре.}\label{fig:8}
\end{figure}

\begin{figure}[h]
\includegraphics[width=0.8\textwidth]{pics/pic. 9.png}
...
\begin{figure}[h]
\includegraphics[width=1.0\textwidth]{pics/pic. 10.png}
...
\begin{figure}[h]
\includegraphics[width=1.0\textwidth]{pics/pic. 11.png}
