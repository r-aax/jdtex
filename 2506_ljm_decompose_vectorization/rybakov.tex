...
\captionstyle{normal}\caption{Please write your figure caption here.}\label{fig:incr}
\end{figure}
...
\captionstyle{normal}\caption{Please write your figure caption here.}\label{fig:code}
\end{figure}
...
\end{tabular}
\captionstyle{normal}\caption{Please write your figure caption here.}\label{fig:chart_speedup}
\end{figure}
