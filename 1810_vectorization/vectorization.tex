...
Other combined vectors in this expression are obtained using the \texttt{perm} instruction (intrinsic function \texttt{\_mm512\_permutexvar\_ps}) applied to the corresponding loaded adjacent rows of the $A$ and $B$ matrices.
