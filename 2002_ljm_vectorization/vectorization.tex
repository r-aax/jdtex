...
After converting the body of the cycle to the predicate form, it can be vectorized. After that, the predicates of the instructions are replaced by vector register-masks (in this place an additional parameter of the vectorized function \texttt{prefun} appears in the form of a mask).
